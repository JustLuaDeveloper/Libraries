...
local Tabs = {
    Scripts = Window:Tab({
        Name = "Scripts", 
        Icon = "rbxassetid://95870104551845", 
        Type = "Script"
    }),
    Settings = Window:Tab({
        Name = "Settings", 
        Icon = "rbxassetid://88951003080071", 
        Type = "Settings"
    }),
}
...
local Script = Tabs.Scripts:Script({
    Name = "TPS (PC)", 
    Icon = "rbxassetid://75700860543862",
    Callback = function(Text)
            game.Players.LocalPlayer:Kick("not released u dumb")
            Library:Unload()
...
local Script3 = Tabs.Scripts:Script({
    Name = "The Classic Soccer", 
    Icon = "rbxassetid://76838193402205",
    Callback = function(Text)
            loadstring(game:HttpGet("https://raw.githubusercontent.com/AtIas-Softworks/Scripts/refs/heads/main/Games/TheClassicSoccer.lua"))()
            Library:Unload()
...
-- 🔧 SETTINGS TAB
-- ==========================================
Tabs.Settings:AddTitle({Text = "UI Settings"})
